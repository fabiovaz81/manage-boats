...
export class DashboardService implements Resolve<any>
{
    ...
    obterDadosVendas(): Observable<any> {

        let url = this._endpointService.obterUrlRestService('inicio/dashboard/obterVendas');
        return this._http
            .post<any>(url, '', {
                observe: 'response',
    ...
    obterQtdClientes(): Observable<any> {

        let url = this._endpointService.obterUrlRestService('inicio/dashboard/obterQtdClientes');
        return this._http
            .post<any>(url, '', {
                observe: 'response',
                headers: this._obterHeaders()
    ...
    obterTicketMedio(): Observable<any> {

        let url = this._endpointService.obterUrlRestService('inicio/dashboard/obterTicketMedio');
        return this._http
            .post<any>(url, '', {
                observe: 'response',
                headers: this._obterHeaders()
    ...
    obterParametros(): Observable<any> {
        let url = this._endpointService.obterUrlRestService('inicio/obterParametros');
    ...
    getPermissonsByUser(codUsuario: number): Observable<any> {
        let url = this._endpointService.obterUrlRestService('inicio/getPermissonsByUser?id=' + codUsuario);
